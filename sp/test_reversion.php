...
$sql="SELECT s.cod_salida_almacenes, s.siat_cuis, sc.cufd, s.siat_cuf from salida_almacenes s, siat_cufd sc 
  where s.siat_codigocufd=sc.codigo and s.cod_salida_almacenes between 21 and 191";
...
while($dat=mysqli_fetch_array($resp)){
  ...
  $sqlUpd="update salida_almacenes set salida_anulada=0 and estado_salida=1 where cod_salida_almacenes='$codVenta'";
