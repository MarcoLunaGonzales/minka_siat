...
$idTabla=1;
$idRecibo=123;
$url="http://localhost:8080/minka_siat/sp/";
$url.="test_servicio_anulacion.php?m=anulaf&t=".$idTabla."&i=".$idRecibo;
$parametros="";   
...
$anularServicio=json_decode($jsons);
print_r($anularServicio->anula);  
?>
