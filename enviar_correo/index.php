...
i.salida_anulada,(select p.nombre_cliente from clientes p where p.cod_cliente=i.cod_cliente) as cliente,
i.cod_cliente,i.cod_chofer,i.siat_fechaemision,i.siat_cuf,i.monto_final FROM salida_almacenes i 
WHERE i.cod_almacen='$global_almacen' and i.salida_anulada!=1 and i.cod_salida_almacenes in ($datos) ";             
$consulta = $consulta."";
            //echo $consulta;
